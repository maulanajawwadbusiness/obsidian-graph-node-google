...
Kupikir ini waktunya untuk kita memikirkan medium informasi yang berbeda di sini.`,
        ...
        "onboarding.enterprompt.input_placeholder_intro": "Cobalah versi beta dari Antarmuka Pengetahuan 2D pertama di dunia",
        "onboarding.enterprompt.input_placeholder": "Tulis apa yang kamu ingin analisis di sini \n\n-----\n\nUnggah atau tempel dokumenmu di sini",
        "onboarding.enterprompt.login.title": "Masuk",
        "onboarding.enterprompt.login.desc": "Kamu akan bisa menggunakan antarmuka cerdas Arnvoid.",
        ...
        "onboarding.enterprompt.beta.info": "Batas beta: maksimal 7.500 kata per dokumen. Harian: 150.000 kata (reset pukul 07:00 WIB).",
        "onboarding.enterprompt.beta.daily_exceeded": "Batas harian beta tercapai (150.000 kata). Reset pukul 07:00 WIB.",
        "onboarding.enterprompt.beta.usage_loading": "Memeriksa penggunaan beta...",
        "onboarding.enterprompt.beta.usage_error": "Gagal memeriksa penggunaan beta.",
        "onboarding.enterprompt.beta.doc_parsing": "Memeriksa dokumen...",
        "onboarding.enterprompt.beta.doc_parse_error": "Gagal memproses dokumen.",
        "onboarding.enterprompt.beta.doc_over_limit": "Dokumen lebih dari 7.500 kata.",
    },
    en: {
        // Node Popup
...
I think it is time for us to think a different medium for ourselves.`,
        ...
        "onboarding.enterprompt.input_placeholder_intro": "Try out beta version of the world's first 2D Knowledge Interface",
        ...
        "onboarding.enterprompt.beta.info": "Beta limit: max 7,500 words per document. Daily: 150,000 words (resets at 07:00 WIB).",
        "onboarding.enterprompt.beta.daily_exceeded": "Daily beta limit reached (150,000 words). Resets at 07:00 WIB.",
        "onboarding.enterprompt.beta.usage_loading": "Checking beta usage...",
        "onboarding.enterprompt.beta.usage_error": "Failed to check beta usage.",
        "onboarding.enterprompt.beta.doc_parsing": "Checking document...",
        "onboarding.enterprompt.beta.doc_parse_error": "Failed to parse document.",
        "onboarding.enterprompt.beta.doc_over_limit": "Document is more than 7,500 words.",
    }
} as const;
